...
Dato interesante: La razón por la que el orden de los bits está cambiada es porque la mayoría de los procesadores modernos son [Little Endian](https://en.wikipedia.org/wiki/Endianness)
